...
RASPBERRY_PIN_CS =  27              #Chip selection pin when SPI is selected, Use BCM code mode, the code number is 27, corresponding to pin GPIO2
...
def setup():
  ...
  #Adopt FIFO for data buffer
  ICM42688.start_FIFO_mode()

def loop():
  #Read data of a FIFO packet
  ICM42688.get_FIFO_data()
